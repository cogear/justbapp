...
export const SpaceInviteEmail = ({
    ...
    spaceName = 'our community',
    personalNote,
    inviteUrl = 'https://theblife.com',
}: {
    inviterName?: string;
    spaceName?: string;
    ...
    <Html>
        <Head />
        <Preview>{`${inviterName} invited you to join ${spaceName} on The B Life`}</Preview>
        <Tailwind
            config={{
                theme: {
                    extend: {
            ...
            <Body className="bg-white my-auto mx-auto font-sans">
                <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
                    ...
                    <Text className="text-black text-[14px] leading-[24px] text-center mt-[16px]">
                        The B Life is a quiet corner of the internet — a community dedicated to the
                        radical act of <em>being</em> in an age of constant <em>doing</em>.
                    </Text>
                    ...
                    <Text className="text-[#666666] text-[12px] leading-[20px] text-center">
                        If this isn&rsquo;t for you, simply ignore this email — we won&rsquo;t write again.
                        <br />
